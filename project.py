...
def nameUpdate():
    while True:
        ...
        #while a2():
            #pass
            if settings["UpdateName"] == True:
                profile = client.getProfile()
                profile.displayName = settings["cName"]
...
#==============================================================================================================#
                                ...
                                if rplace == "on":
                                        settings["atjointicket"]=True
                                elif rplace == "off":
                                        settings["atjointicket"]=False
                                client.sendText(msg.to,"Auto Join Group by Ticket is %s" % str(wait["atjointicket"]))
                                ...
                                for ticket_id in n_links:
                                        if settings["atjointicket"] == True:
                                                ...
                                                client.sendText(msg.to,"Sukses join ke grup %s" % str(group.name))
...
#==============================================================================================================================#
                                ...
                                if msg.toType == 2:
                                    ...
                                    client.updateGroup(X)
                                    if settings["lang"] == "JP":
                                        client.sendText(msg.to,"「Url closed」")
#============================================================#READ#=========================================================#
...
#============================================================#READ FINISH#=========================================================#
                                ...
                                if settings['sambutan'] == True:
                                    if settings["lang"] == "JP":
                                        client.sendText(msg.to, "「Auto welcome set to on」")
                                    else:
                                        client.sendText(msg.to, "「Auto welcome set to on」")
                                else:
                                ...
                                if settings['sambutan'] == False:
                                    if settings["lang"] == "JP":
                                        client.sendText(msg.to, "「Auto welcome set to off」")
                                    else:
                                        client.sendText(msg.to, "「Auto welcome set to off」")
                                else:
                                ...
                                if settings['respontag'] == True:
                                    if settings["lang"] == "JP":
                                        client.sendText(msg.to, "「Auto tag set to on」")
                                    else:
                                        client.sendText(msg.to, "「Auto tag set to on」")
                                else:
                                ...
                                if settings['respontag'] == False:
                                    if settings["lang"] == "JP":
                                        client.sendText(msg.to, "「Auto tag set to off」")
                                    else:
                                        client.sendText(msg.to, "「Auto tag set to off」")
                                else:
                                ...
                                if settings['protecteasy'] == True:
                                    if settings["lang"] == "JP":
                                        client.sendText(msg.to, "「Sensitive set to on」")
                                    else:
                                        client.sendText(msg.to, "「Sensitive set to on」")
                                else:
                                    settings["protecteasy"] = True
                                    if settings["lang"] == "JP":
                                        client.sendText(msg.to,"「Sensitive set to on」")
                                    else:
                                        client.sendText(msg.to,"「Sensitive set to on」")
                                ...
                                if settings['protecteasy'] == False:
                                    if settings["lang"] == "JP":
                                        client.sendText(msg.to, "「Sensitive set to off」")
                                    else:
                                        client.sendText(msg.to, "「Sensitive set to off」")
                                else:
                                    settings["protecteasy"] = False
                                    if settings["lang"] == "JP":
                                        client.sendText(msg.to,"「Sensitive set to off」")
                                    else:
                                        client.sendText(msg.to,"「Sensitive set to off」")
                                ...
                                if settings['qrpro'] == True:
                                    if settings["lang"] == "JP":
                                        client.sendText(msg.to, "「Qr set to on」")
                                    else:
                                        client.sendText(msg.to, "「Qr set to on」")
                                else:
                                    settings["qrpro"] = True
                                ...
                                if settings['qrpro'] == False:
                                    if settings["lang"] == "JP":
                                        client.sendText(msg.to, "「Qr set to off」")
                                    else:
                                        client.sendText(msg.to, "「Qr set to off」")
                                else:
                                    settings["qrpro"] = False
                                    if settings["lang"] == "JP":
                                        client.sendText(msg.to,"「Qr set to off」")
                                    else:
                                        client.sendText(msg.to,"「Qr set to off」")
...
#============================================================#Mystatus start#=========================================================#
                                ...
                                if settings["sambutan"] == True: md+=" 「❧Status : Auto wc set to on」\n"
                                else: md +=" 「❧Status : Auto wc set to off」\n"
                                if settings["respontag"] == True: md+=" 「❧Status : Auto tag set to on」\n"
                                else: md +=" 「❧Status : Auto tag set to off」\n"
                                if settings["protecteasy"] == True: md+=" 「❧Status : Sensitive set to on」\n"
                                else: md +=" 「❧Status : Sensitive set to off」\n"
                                if settings["qrpro"] == True: md+=" 「❧Status : Qr set to on」"
                                else: md +=" 「❧Status : Qr set to off」"
